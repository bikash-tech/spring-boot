...
public class SellerEnquiryControllerTest {
	@Autowired
	...
	@Test
	public void getEnquiryByEmptyENQNumber() throws Exception {
		String uri = "/api/v1/seller/enquiry/null";
		UtrustResponse utrustResponse = Mockito.mock(UtrustResponse.class);
		Mockito.when(enquiryService.getEnquiryDetails("", null)).thenReturn(utrustResponse);
