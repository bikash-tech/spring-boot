...
public class TemporaryRegNumberTest {
	@Autowired
	...
	@Test
	public void getTemporaryRegNumber() throws Exception {
		String uri = "/api/v1/seller/temp-registration-number";
		UtrustResponse utrustResponse = Mockito.mock(UtrustResponse.class);
		Mockito.when(enquiryService.getTemporaryRegistrationNumber(null)).thenReturn(utrustResponse);
